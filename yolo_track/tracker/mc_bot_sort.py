...
import msinetpred
from msinetpred import extract_features
...
class BoTSORT(object):
    ...
    def update(self, output_results, img, frameID=0):
        ...
        if self.args.with_reid:
            features_keep = extract_features(img, dets) # self.encoder.inference(img, dets)
        ...
        if len(scores):
            ...
            if self.args.with_reid:
                features_second = extract_features(img, dets_second) #self.encoder.inference(img, dets_second)
